...
\begin{frame}{LSTM for the time series}
    We used a ``many to one'' configuration of the lstm layer, 
    taking only the value of the last iteration and not the whole sequence of outputs or cell values 
    \begin{columns}
        \column{0.5\textwidth}
        \begin{figure}
            \centering
...
\begin{frame}{Subnets comparison}
    \begin{figure}
        \centering
        \includegraphics[width=\linewidth]{figures/subnet_comparison_final.png}
    \end{figure}
\end{frame}
...
\begin{frame}{Freeze or not to freeze}

    \begin{figure}
        \centering
        \includegraphics[width=\linewidth]{figures/net_freeze_comparison.png}
    \end{figure}
